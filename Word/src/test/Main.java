...
public class Main {
	...
	public static void main(String[] args) {
		...
		tentativi.add(new Tentativo (new Cella[] { new Cella('c', Colore.GIALLO), new Cella('a', Colore.GIALLO),
				new Cella('s', Colore.GIALLO), new Cella('t', Colore.GRIGIO), new Cella('e', Colore.GRIGIO) }));
